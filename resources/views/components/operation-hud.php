  <div id="operationHud" class="pointer-events-none fixed bottom-5 right-5 z-40 hidden w-[min(420px,calc(100vw-40px))] overflow-hidden rounded-3xl border border-white/10 bg-[#08111f]/95 shadow-[0_28px_90px_rgba(0,0,0,.45)] backdrop-blur-xl">
